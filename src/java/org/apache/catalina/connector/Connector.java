 ...
 * 
 * 由ConnectorCreateRule对象在解析server.xml中Connector标签时,产生该对象
 */
    ...
    implements Lifecycle, MBeanRegistration
{
    ...
    public Connector(String protocol)
        throws Exception {
        setProtocol(protocol);//根据protocol,查找具体的实现类
     ...
     * 该Connector在server.xml中的配置信息所在的Service对象
     */
     ...
     * paramter的参数最多个数,参见org.apache.catalina.connector.Request.parseParameters()方法
     */
     ...
     * 为standerService,即包含他内部的Container的service
     */
     ...
     * 一般是StandardEngine做为容器,参见StandardService类setContainer方法
     */
