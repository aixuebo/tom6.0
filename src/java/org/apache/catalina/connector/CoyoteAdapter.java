...
/**
 * 是否设置服务器配置属性暴露给客户端,如果是，则将信息写入返回头X-Powered-By中
 */
    ...
    protected boolean postParseRequest(org.apache.coyote.Request req, 
    	...
    	/**
    	 * 根据scheme是否为null,设置安全属性的boolean值.
    	 * 当其不为空时,如果值为https，则设置为true,否则设置为false。
    	 * 当其为空时,设置scheme和Secure都是走默认值，默认值在connector中
    	 */
        ...
        //如果使用代理,则为request设置setServerPort和serverName
