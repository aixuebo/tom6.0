 ...
 * xml规则参见NamingResources类
 * 
 * 定义server.xml中Server/GlobalNamingResources/的子标签
 * 同时也定义
 * 定义server.xml中Server/Service/Engine/Host/Context/的子标签
 */
...
public class NamingRuleSet extends RuleSetBase {
    ...
    public void addRuleInstances(Digester digester) {
        ...
        digester.addRule(prefix + "Resource", new SetAllPropertiesRule());//设置Resource资源中属性到ContextResource中set方法里面
