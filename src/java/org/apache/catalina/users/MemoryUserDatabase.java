...
public class MemoryUserDatabase implements UserDatabase {
     ...
     * 删除角色,
     * 先循环group,把组中包含该角色的删除掉
     * 先循环user,把user中包含该角色的删除掉
     * 最后删除该角色
     */
    ...
    public void save() throws Exception {
      ...
      //如果是readOnley的,则不需要保存
        ...
        //保存规则,先向new文件保存,然后更新现有文件为old文件,然后把new改成现有文件,跟hadoop文件更改类似原理
