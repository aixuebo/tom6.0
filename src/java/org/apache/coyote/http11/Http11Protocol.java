...
//因为实现了Handler方法,该方法接收socket参数,因此表示一次请求
    protected static class Http11ConnectionHandler implements Handler {
        ...
        protected ConcurrentLinkedQueue<Http11Processor> recycledProcessors = 
            ...
            public boolean offer(Http11Processor processor) {//使用完成后,还回队列
                ...
                return result;//返回值true表示添加成功,返回false表示添加失败,并且注销了该Http11Processor对象
            }
            ...
            //不断循环取出Http11Processor对象,每次注销该Http11Processor对象,最后清空size
            public void clear() {
        ...
        /**
         * 创建若干个Http11Processor对象,缓存起来,循环使用,每个Http11Processor对象都会接收一次socket请求,使用process方法处理每一个socket对象
         */
