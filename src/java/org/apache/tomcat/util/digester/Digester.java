...
public class Digester extends DefaultHandler {
     ...
     * 当前处理的xml元素的全路径,例如：root/name/age
     */
     ...
     * 命名空间映射集合，key是命名空间key，value是该命名空间对应的堆栈ArrayStack对象。
     * 该命名空间是随着xml解析，动态添加到namespaces中的。即当解析到该命名空间时，就会添加到该集合中。
     */
   ...
   /**
     ...
     * 通过命名空间前缀，查找该命名空间对应的堆栈集合ArrayStack，并且返回该堆栈上最后一个添加到字符串。
     */
     ...
     * 返回当前处理的xml的元素名字，例如root/name/age.返回age
     */
