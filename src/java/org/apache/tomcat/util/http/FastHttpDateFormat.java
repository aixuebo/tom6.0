...
public final class FastHttpDateFormat {
    ...
    /**
     * Formatter cache.
     * 缓存了一些个时间对应，key是long类型的时间戳，value是字符串时间。
     */
    ...
    public static final String formatDate
        ...
        String cachedDate = formatCache.get(longValue);//有缓存，则直接返回缓存的值
        if (cachedDate != null)
            return cachedDate;
    ...
    public static final long parseDate(String value, 
        ...
        Long cachedDate = parseCache.get(value);//先到解析缓存中查看是否存在
        if (cachedDate != null)
     ...
     * 根据第二个数组参数格式，解析value。一直到value成功被解析为止。返回该value对应的时间戳
     */
